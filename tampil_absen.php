...
<div class="table-responsive">
        ...
        // melakukan query untuk mendapatkan data dari tabel absen
        ...
        $no = 1;
                while ($data = mysqli_fetch_array($hasil)) {
                  ...
                  <tr>
                    ...
                    <td>
                    <img src="img/<?= $data['foto'] ?>" alt="<?= $data['nama'] ?>" width="100">
                    </td>
                    <td>
                      <a href="delete_absen.php?id=<?= $data['id'] ?>" class="btn btn-danger btn-primary">Hapus</a>
                    </td>
                  </tr>
                  <?php
                  $no++;
