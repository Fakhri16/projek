...
// validasi serial
$query = "SELECT nomor_serial FROM tbl_barang WHERE nomor_serial='$nomor_serial' and not nomor_serial='$nomor_serial_lama' ";
...
if (mysqli_num_rows($ada) > 0) {
    ...
    $query = "UPDATE tbl_barang SET nama_tipe='$nama_tipe', brand='$brand', detail_tipe='$detail_tipe', nomor_serial='$nomor_serial', pengirim='$pengirim',penerima='$penerima',
    posisi='$posisi', tgl_beli='$tanggalBeli', lokasi='$lokasi', kondisi='$kondisi', User='$User', deskripsi='$deskripsi' WHERE id='$id' ";
