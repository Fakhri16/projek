...
<?php
    include('function_tanggal.php');
        ...
        if (isset($_POST['search'])) {
          ...
          $query = "SELECT * FROM tbl_barang WHERE brand LIKE '%$brand%' AND pengirim LIKE '%$pengirim%' AND tgl_beli LIKE '%$tgl_beli%' AND User LIKE '%$User%' AND lokasi Like '%$lokasi%' AND nomor_serial LIKE '%$nomor_serial%'
                    ORDER BY id  ";
        } else {
          $query = "SELECT * FROM tbl_barang ORDER BY id";
        }
        ...
        <div class="container table-responsive card-body">
          <form action="" method="POST">
            ...
            <div class="box mb-3">
              ...
              <input type="text" name="User" class="" autocomplete="off">
            </div>
            <div class="box mb-3">
              <label for=""> lokasi </label>
              <input type="text" name="lokasi" class="" autocomplete="off">
            </div>
          ...
          <div class="">
            ...
            <a class="btn btn-light" href="halaman.php" role="button">kembali</a>
          </div>
          </div>
              ...
              <tbody>
                ...
                while ($data = mysqli_fetch_array($hasil)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="form_update.php?id=<?= $data['id'] ?>" class="btn btn-success">Edit</a>
                      <a href="act_delete.php?id=<?= $data['id'] ?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                  <?php
                  $no++;
